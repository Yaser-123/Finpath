...
description: Generates an Antigravity skill directory, including the required SKILL.md file with YAML frontmatter, following the established structural templates and best practices. Use this when the user asks to build or create a new skill for the agent.
---
...
- The user requests to "create a skill", "build a skill", or "incorporate a new skill".
- The user wants to package an operational workflow into a formalized Antigravity skill format.
